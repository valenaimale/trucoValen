...
public class Truco {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Carta> cartasRepartidas2=new ArrayList<>();
        Jugador jugador1=new Jugador("valentino",cartasRepartidas);
        Jugador jugador2=new Jugador("ariel",cartasRepartidas2);
